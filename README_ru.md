...
Мы приветствуем вклад сообщества! Ознакомьтесь с [CONTRIBUTING.md](CONTRIBUTING.md) — там описаны процесс разработки, стандарты кодирования и порядок создания pull request'ов.
